...
/*Because that is the closure. A child can reach out of its scope for a value. But if it were reversed and nestedFunction had a value inside of it and myFunction tried to get the value it wouldn't work because on the child can take from the parent.
*/
  ...
  */
  ...
  function animalNames(){
    zooAnimals.forEach(function(item){
      return names.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    });
    return names;
  }
